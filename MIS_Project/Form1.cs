...
namespace MIS_Project
{
    public partial class Form1 : Form
    {
        ...
        public static string con_str = @"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=|DataDirectory|\misProj.mdb;";
       ...
       /* public int C_ID { get; set; }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            this.dataTable1TableAdapter.Fill(this.dataSet11.DataTable1, dateTimePicker1.Text, dateTimePicker2.Text, comboBox2.Text, comboBox1.Text);
            // TODO: This line of code loads data into the 'dataSet11.DataTable1' table. You can move, or remove it, as needed.
            this.dataTable1TableAdapter.Fill(this.dataSet11.DataTable1, dateTimePicker1.Text, dateTimePicker2.Text, comboBox2.Text, comboBox1.Text);
            // TODO: This line of code loads data into the 'dataSet11.DataTable1' table. You can move, or remove it, as needed.

            // TODO: This line of code loads data into the 'misProjDataSet11.product' table. You can move, or remove it, as needed.
            this.productTableAdapter1.Fill(this.misProjDataSet11.product);
            // TODO: This line of code loads data into the 'misProjDataSet1.DataTable1' table. You can move, or remove it, as needed.
            // this.dataTable1TableAdapter.Fill(this.misProjDataSet1.DataTable1,dateTimePicker1.Text,dateTimePicker2.Text,comboBox1.Text,comboBox2.Text);
            // TODO: This line of code loads data into the 'misProjDataSet.order_Product' table. You can move, or remove it, as needed.
            ...
            // TODO: This line of code loads data into the 'dataSet11.DataTable4' table. You can move, or remove it, as needed.
            //this.dataTable4TableAdapter.Fill(this.dataSet11.DataTable4);
            ...
            //OleDbCommand cmd = new OleDbCommand();
            cmd.Connection = conn;
            string query1 = "select p_name from product;";
            ...
            //OleDbCommand cmd = new OleDbCommand();
            cmd.Connection = conn;
            string query2 = "select area from customer group by area;";
            ...
            conn.Open();
            //OleDbCommand cmd = new OleDbCommand();
            string query11 = "SELECT product.P_id, product.P_name, Avg(product.P_unitPrice) AS AvgOfP_unitPrice, Avg(product.initQuantity) AS AvgOfinitQuantity, Sum(order_Product.quantitySold) AS SumOfquantitySold FROM order_Product RIGHT JOIN product ON order_Product.P_Id = product.P_id GROUP BY product.P_id, product.P_name";
        ...
        private void btn_login_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Close();
                string usr_name = "select fname & ' ' & lname from Admin where email = '" + txt_loginuser.Text + "'";
                conn.Open();

                cmd.CommandText = usr_name;
                cmd.Connection = conn;
                OleDbDataReader reader = cmd.ExecuteReader();
                ...
                string usr_det = "SELECT fname, lname, email,password,phone,address FROM Admin where email = '" + txt_loginuser.Text + "'";
                conn.Open();

                cmd.CommandText = usr_det;
                cmd.Connection = conn;
                //OleDbDataReader reader = cmd.ExecuteReader();
                OleDbDataReader reader1 = cmd.ExecuteReader();
                while (reader1.Read())
                {
                    txt_adminfname.Text = reader1[0].ToString();
                    txt_adminlname.Text = reader1[1].ToString();
                    txt_adminEmail.Text = reader1[2].ToString();
                    txt_adminPass.Text = reader1[3].ToString();
                    txt_adminPhone.Text = reader1[4].ToString();
                    txt_adminAdd.Text = reader1[5].ToString();
            ...
            {              
                ...
                {
                    conn.Close();
                    string usr_name = "select fname & ' ' & lname from employee where email = '" + txt_loginuser.Text + "'";
                    conn.Open();
                    ...
                    string emp_det = "SELECT fname, lname, email,password,phone,address FROM employee where email = '" + txt_loginuser.Text + "'";
                    conn.Open();

                    cmd.CommandText = emp_det;
                    cmd.Connection = conn;
                    //OleDbDataReader reader = cmd.ExecuteReader();
                    OleDbDataReader reader2 = cmd.ExecuteReader();
                    while (reader2.Read())
                    {
                        txt_empfname.Text = reader2[0].ToString();
                        txt_emplname.Text = reader2[1].ToString();
                        txt_empEmail.Text = reader2[2].ToString();
                        txt_empPass.Text = reader2[3].ToString();
                        txt_empPhone.Text = reader2[4].ToString();
                        txt_empAddess.Text = reader2[5].ToString();
                ...
                else
                {
                    ...
                    label14.Text = "username or password is incorrect";
                }
            }
            //label13.Visible = true;
            //label13.Text = "Username or Password is Incorrect";
        ...
        private void btn_signup_Click(object sender, EventArgs e)
        {
            ...
            OleDbCommand cmd = new OleDbCommand();
            //string check;
            string query0 = "select count(*) from employee where email='" + txt_signemail.Text + "'";
        ...
        private void btn_SignOut_Click(object sender, EventArgs e)
        {
            ...
            panel_AdminSide.Visible = false;
            panel_employeeSide.Visible = false;
        ...
        {
            //this.dataTable1TableAdapter.Fill(dataSet1.DataTable1);
            ...
            string queryx = "select p_unitPrice from product where p_name='" + comboBox_selectProduct1.Text + "'";

            string unitPrice = "";
            conn.Open();
            //OleDbCommand cmd = new OleDbCommand();
            cmd.CommandText = queryx;
            cmd.Connection = conn;
            OleDbDataReader reader9 = cmd.ExecuteReader();
            while (reader9.Read())
            {
                unitPrice = reader9["p_unitPrice"].ToString();
            }
            //MessageBox.Show("pid = " + unitPrice);
            conn.Close();
            ...
            panel_order3.Visible = true;
            label27.Text = cid;
            label28.Text = txt_Cusfname.Text+" " + txt_Cuslname.Text; 
            label29.Text = txt_CusStreetAdd.Text;
            label30.Text = txt_CusArea.Text;
            label31.Text = txt_CusCity.Text;
            label32.Text = label9.Text;
            label33.Text = date1;
            label34.Text = pid;
            label35.Text = comboBox_selectProduct1.Text;
            label36.Text = unitPrice;
            label37.Text = txt_productQuantity1.Text;
            int total = (Convert.ToInt32(unitPrice) * Convert.ToInt32(txt_productQuantity1.Text));
            label38.Text = total.ToString();

            /*this.dataTable2TableAdapter.Fill(this.misProjDataSet.DataTable2, Convert.ToInt16(cid), txt_Cusfname.Text, txt_Cuslname.Text, txt_CusStreetAdd.Text, txt_CusArea.Text, txt_CusCity.Text, Convert.ToInt16(label9.Text), date1);
            
            Microsoft.Reporting.WinForms.ReportParameter[] para = new Microsoft.Reporting.WinForms.ReportParameter[]
            {
                new Microsoft.Reporting.WinForms.ReportParameter("C_ID", cid.ToString()),
                new Microsoft.Reporting.WinForms.ReportParameter("C_fname", txt_Cusfname.Text),
                new Microsoft.Reporting.WinForms.ReportParameter("C_lname", txt_Cuslname.Text),
                new Microsoft.Reporting.WinForms.ReportParameter("C_Address", txt_CusStreetAdd.Text),
                new Microsoft.Reporting.WinForms.ReportParameter("C_Area", txt_CusArea.Text),
                new Microsoft.Reporting.WinForms.ReportParameter("C_city", txt_CusCity.Text),
                new Microsoft.Reporting.WinForms.ReportParameter("O_id", label9.Text),
                new Microsoft.Reporting.WinForms.ReportParameter("OrderDate", date1),
            };
            reportViewer2.LocalReport.SetParameters(para);
            
            //this.dataTable1TableAdapter.Fill(this.dataSet11.DataTable1,2);
            this.reportViewer1.RefreshReport();*/
        ...
        private void btn_empProfileSave_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            string query = "update [employee] set [fname]='" + txt_empfname.Text + "',[lname]='" + txt_emplname.Text + "',[email]='" + txt_empEmail.Text + "',[password]='" + txt_empPass.Text + "',[phone]='" + txt_empPhone.Text + "',[address]='" + txt_empAddess.Text + "' where e_id=" + id;
            //OleDbCommand cmd = new OleDbCommand();
            cmd.CommandText = query;
            cmd.Connection = conn;
            MessageBox.Show(query);
        ...
        private void btn_adminProfileSave_Click(object sender, EventArgs e)
        {

            conn.Open();
            string query2 = "select id from admin where email='" + txt_loginuser.Text + "'";
            string id = "";
            //conn.Open();
            ...
            conn.Open();
            string query = "update [admin] set [fname]='"+txt_adminfname.Text+"',[lname]='"+txt_adminlname.Text+ "',[email]='" + txt_adminEmail.Text +"',[password]='"+ txt_adminPass.Text+ "',[phone]='" + txt_adminPhone.Text+"',[address]='" + txt_adminAdd.Text + "' where id="+id; 
            //OleDbCommand cmd = new OleDbCommand();
            cmd.CommandText = query;
            cmd.Connection = conn;
            MessageBox.Show(query);
        ...
        private void panel_Report_Paint(object sender, PaintEventArgs e)
        {
        ...
        {
            this.dataTable1TableAdapter.Fill(this.dataSet1.DataTable1, dateTimePicker1.Text, dateTimePicker2.Text, comboBox2.Text, comboBox1.Text);
                //dataTable1TableAdapter.Fill(this.misProjDataSet11.DataTable1, dateTimePicker1.Text, dateTimePicker2.Text, comboBox1.Text, comboBox2.Text);
            this.reportViewer2.RefreshReport();
        }
        ...
        private void panel_order3_Paint(object sender, PaintEventArgs e)
        {
